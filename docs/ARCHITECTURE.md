...
already-made decision into something a human can act on. Issues #13
(expose it via the API) and #14 (persist it against a Ticket for the
Staff Dashboard) build on top of this.
